            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <button
                  ...
                  className={`flex items-center gap-1.5 text-[11px] px-2.5 py-1.5 rounded-lg border transition-all ${step[opt.field] ? "border-gray-600 bg-gray-600 text-white" : "border-gray-200 text-gray-500 hover:border-gray-400"}`}
                >
              ...
              <div>
                ...
                <div className="space-y-1.5">
                  {SHIPPING_METHODS.map(m => (
                    ...
                    >
                      <div className={`w-4 h-4 rounded border flex items-center justify-center flex-shrink-0 transition-colors ${form.shippingMethods.includes(m.id) ? "bg-gray-600 border-gray-600" : "border-gray-300"}`}>
