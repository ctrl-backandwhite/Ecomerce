...
import {
  Plus, Edit, Trash2, X, Check, GripVertical,
  Tag, AlertCircle, Search, ToggleLeft, ToggleRight,
...
function CategoryModal({
  ...
  const field = "w-full text-sm text-gray-900 border border-gray-200 rounded-xl px-3 py-2.5 focus:outline-none focus:border-gray-400 placeholder-gray-300";
    ...
    <DndProvider backend={HTML5Backend}>
      <div className="h-full flex flex-col space-y-5">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">
              {parentCategories.length} categorías · {totalSubcategories} subcategorías · {totalProducts} productos
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            { label: "Total categorías",    value: parentCategories.length },
            { label: "Activas",             value: parentCategories.filter((c) => c.status === "active").length },
            { label: "Total subcategorías", value: totalSubcategories },
            { label: "Productos asignados", value: totalProducts },
          ].map(({ label, value }) => (
        ...
        <div className="bg-white border border-gray-100 rounded-xl px-4 py-3.5">
          <div className="relative max-w-xs">
            ...
            <input
              ...
              placeholder="Buscar por nombre o keywords..."
        ...
        <div className="bg-white border border-gray-100 rounded-xl overflow-hidden">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-gray-900 rounded-lg flex items-center justify-center">
                  <Filter className="w-3.5 h-3.5 text-white" strokeWidth={1.5} />
                </div>
                <span className="text-xs font-medium text-gray-900">Filtros</span>
              </div>

              {/* Status filter */}
              <div className="flex items-center gap-2">
                <label className="text-[11px] text-gray-400 uppercase tracking-wider">Estado:</label>
                <select
                  value={filterStatus}
                  onChange={(e) => {
                  ...
                  className="text-xs font-medium text-gray-900 bg-white border-2 border-gray-200 rounded-xl px-3.5 py-2 focus:outline-none focus:border-gray-900 hover:border-gray-300 transition-colors cursor-pointer"
                >
                  <option value="all">📋 Todos los estados</option>
                  <option value="active">✅ Solo activas</option>
                  <option value="inactive">⏸️ Solo inactivas</option>
                </select>
              </div>

              {/* Published filter */}
              <div className="flex items-center gap-2">
                <label className="text-[11px] text-gray-400 uppercase tracking-wider">Publicación:</label>
                <select
              ...
              {/* Draft count badge and actions */}
              {draftCount > 0 && (
                <div className="flex items-center gap-2 ml-auto">
                  <div className="flex items-center gap-2 bg-orange-50 border border-orange-200 rounded-xl px-3 py-2">
                    <div className="w-5 h-5 bg-orange-500 rounded-md flex items-center justify-center">
                      <span className="text-[10px] font-bold text-white">{draftCount}</span>
                    </div>
                    <span className="text-xs font-medium text-orange-700">
                      Borrador{draftCount > 1 ? "es" : ""}
                    </span>
                  </div>
                  <button
                    onClick={() => setShowPreview(true)}
                    className="inline-flex items-center gap-1.5 text-xs font-medium text-gray-700 bg-white border-2 border-gray-200 rounded-xl px-4 py-2 hover:bg-gray-50 hover:border-gray-900 transition-all"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-medium text-white bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl px-4 py-2 hover:from-blue-600 hover:to-blue-700 transition-all shadow-sm hover:shadow"
                  >
                    <Send className="w-3.5 h-3.5" strokeWidth={1.5} />
                    Publicar todos
                  </button>
          ...
          {/* Stats Row */}
          <div className="px-4 py-3 bg-gray-50 grid grid-cols-4 gap-3">
            <div className="bg-white rounded-lg px-3 py-2.5 border border-gray-100">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-900">{parentCategories.length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg px-3 py-2.5 border border-gray-100">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-[10px] text-gray-400 uppercase tracking-wider">Publicadas</p>
                  <p className="text-sm font-bold text-gray-900">{parentCategories.filter(c => c.published).length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg px-3 py-2.5 border border-gray-100">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 bg-orange-50 rounded-lg flex items-center justify-center">
                  <FileText className="w-3.5 h-3.5 text-orange-600" strokeWidth={1.5} />
                </div>
                <div>
                  <p className="text-[10px] text-gray-400 uppercase tracking-wider">Borradores</p>
                  <p className="text-sm font-bold text-gray-900">{draftCount}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg px-3 py-2.5 border border-gray-100">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 bg-purple-50 rounded-lg flex items-center justify-center">
                  <Layers className="w-3.5 h-3.5 text-purple-600" strokeWidth={1.5} />
                </div>
                <div>
                  <p className="text-[10px] text-gray-400 uppercase tracking-wider">Subcategorías</p>
                  <p className="text-sm font-bold text-gray-900">{list.filter(c => c.parent_id).length}</p>
                </div>
              </div>
            </div>
          </div>
