    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <Link to="/" className="inline-flex items-center gap-2 text-sm text-white bg-gray-900 px-5 py-2.5 rounded-xl hover:bg-gray-700 transition-colors">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden shadow-sm">
            ...
            {items.map(p => (
              <div key={p.id} className="p-5 border-r last:border-r-0 border-gray-100">
                <div className="relative">
                  ...
                  <button
                    onClick={() => handleAdd(p)}
                    className="w-full flex items-center justify-center gap-1.5 h-8 text-xs text-white bg-gray-900 rounded-lg hover:bg-gray-700 transition-colors"
                  >
          ...
          {items.some(p => p.attributes?.length > 0) && (
            <>
              <div className="grid bg-gray-900/5" style={{ gridTemplateColumns: `200px repeat(${items.length}, 1fr)` }}>
